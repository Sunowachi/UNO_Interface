...
// Карта состояния графиков (зарезервировано)
...
export function drawCurrent() {
    ...
    for (let idx = 0; idx < vars.length; idx++) {
        ...
        // Определение, является ли переменная ссылкой на другой датчик
...
/** Рисование оси Y на отдельном canvas */
