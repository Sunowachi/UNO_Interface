...
// Флаг, указывающий, следует ли "идти за хвостом" (автоскроллить в конец при новых данных)
// chartFollow[chartId] = true/false
...
// Ограничения размера canvas в пикселях (чтобы холст не рос ��есконечно)
